...
- **Markdown Export**: Direct markdown table formatted for GitHub READMEs, Obsidian, or Notion notes (`export(matrix, "markdown")`).
- **CSV Export**: Standard UTF-8 comma-delimited table suitable for spreadsheets (`export(matrix, "csv")`).
